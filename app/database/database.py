...
def init_db():
    ...
    test_user_1 = User(id=1,email="Bob", password="123")
    create_user(test_user_1)
    test_user_2 = User(id=2,email="Sam", password="123")
    create_user(test_user_2)
    test_user_3 = User(id=3,email="Alice", password="123")
    create_user(test_user_3)
    test_admin_1 = Admin(id=1,email="Jack", password="123")
